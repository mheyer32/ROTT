...
// MENU ITEMS
//
CP_MenuNames MainMenuNames[] = {"NEW GAME",     "COMM-BATÅ GAME", "RESTORE GAME",
...
CP_MenuNames CtlMenuNames[] = {"MOUSE ENABLED",    "JOYSTICK ENABLED",  "USE JOYSTICK PORT 2",
                               "GAMEPAD ENABLED",  "SPACEBALL ENABLED", "CYBERMAN ENABLED",
...
CP_itemtype CusMenu[] = {
    {CP_Active, "ctl_mic\0", 'a', NULL}, {CP_Inactive, "ctl_mic\0", 'a', NULL}, {CP_Inactive, "ctl_mic\0", 'a', NULL},
    {CP_Active, "ctl_mic\0", 'a', NULL}, {CP_Inactive, "ctl_mic\0", 'a', NULL}, {CP_Inactive, "ctl_mic\0", 'a', NULL},
    {CP_Active, "ctl_mic\0", 'a', NULL}, {CP_Inactive, "ctl_mic\0", 'a', NULL}, {CP_Active, "ctl_mic\0", 'a', NULL}};
...
CP_itemtype ControlSelectMenu[] = {
    {2, "\0", 'N', NULL}, {1, "\0", 'L', NULL}, {1, "\0", 'R', NULL}, {1, "\0", 'F', NULL}, {1, "\0", 'B', NULL},
    {1, "\0", 'R', NULL}, {1, "\0", 'O', NULL}, {1, "\0", 'F', NULL}, {1, "\0", 'S', NULL}, {1, "\0", 'S', NULL},
    {1, "\0", 'S', NULL}, {1, "\0", 'L', NULL}, {1, "\0", 'L', NULL}, {1, "\0", 'A', NULL}, {1, "\0", 'A', NULL},
    {1, "\0", 'A', NULL}, {1, "\0", 'T', NULL}, {1, "\0", 'D', NULL}, {1, "\0", 'V', NULL}, {1, "\0", 'A', NULL},
    {1, "\0", 'M', NULL}};
...
// bna added
CP_MenuNames ExtOptionsNames[] = {"MOUSELOOK", "INVERSE MOUSE", "CROSS HAIR", "JUMPING", "FULLSCREEN"};
...
CP_itemtype AmmoPerWeaponMenu[] = {{2, "b_one\0", 'O', NULL}, {1, "b_normal\0", 'N', NULL}, {1, "b_gunf\0", 'G', NULL}};
...
CP_itemtype SpawnMenu[] = {{2, "b_danger\0", 'S', NULL}, {1, "b_health\0", 'S', NULL}, {1, "b_weap\0", 'S', NULL},
                           {1, "b_mines\0", 'S', NULL},  {1, "b_rpawn\0", 'R', NULL},  {1, "b_persis\0", 'W', NULL},
...
CP_itemtype LightLevelMenu[] = {{2, "b_dark\0", 'D', NULL}, {1, "b_normal\0", 'N', NULL}, {1, "b_bright\0", 'B', NULL},
                                {1, "b_fog\0", 'F', NULL},  {1, "b_period\0", 'P', NULL}, {1, "b_light\0", 'L', NULL}};
...
CP_itemtype PointGoalMenu[] = {{2, "b_1\0", 'a', NULL},      {1, "b_5\0", 'a', NULL},     {1, "b_11\0", 'a', NULL},
    ...
    do {
        ...
        if (numactive > 1) {
            ...
            case dir_South:
                ...
                // Do a half step if possible
                if ((handlewhich != item_i->amount - 1) && (((items + handlewhich + 1)->active == CP_CursorLocation) ||
                                                            ((items + handlewhich + 1)->active == CP_Active))) {
                    y += 6;
                    DrawHalfStep(x, y);
                    playsnd = false;
...

{
    ...
    do {
        ...
        case 6:
            BATTLE_Options[gamestate.battlemode].RandomWeapons = !BATTLE_Options[gamestate.battlemode].RandomWeapons;
            break;
...
static int midinums[12] = {0x220, 0x230, 0x240, 0x250, 0x300, 0x320, 0x330, 0x332, 0x334, 0x336, 0x340, 0x360};
...
// MENU ITEMS
//
CP_MenuNames SoundSetupMenuNames[] = {"SETUP SOUND FX", "SETUP MUSIC", "SOUND FX VOLUME", "MUSIC VOLUME", "QUIT"};

CP_iteminfo SoundSetupMenuItems = {MENU_X, 48, 5, STARTITEM, 32, SoundSetupMenuNames, mn_largefont};
CP_itemtype SoundSetupMenu[] = {{CP_CursorLocation, "\0", 'S', (menuptr)SS_SoundMenu},
...
CP_MenuNames SoundSetupMusicNames[] = {"None",   "Ultrasound", "Sound Blaster", "Sound Man 16", "Pro Audio Spectrum",
                                       "AWE 32", "Soundscape", "Wave Blaster",  "General Midi", "Sound Canvas",
                                       "Adlib"};

CP_iteminfo SoundSetupMusicItems = {44, MENU_Y + 15, 11, STARTITEM, 16, SoundSetupMusicNames, mn_smallfont};
CP_itemtype SoundSetupMusic[] = {{CP_CursorLocation, "\0", 'N', (menuptr)SS_SetupMusicCardMenu},
...
CP_MenuNames SoundSetupSoundNames[] = {
    "None",       "Ultrasound", "Sound Blaster",       "Sound Man 16",       "Pro Audio Spectrum", "AWE 32",
    "Soundscape", "Adlib",      "Disney Sound Source", "Tandy Sound Source", "PC Speaker"};

CP_iteminfo SoundSetupSoundItems = {MENU_X, MENU_Y + 15, 11, STARTITEM, 16, SoundSetupSoundNames, mn_smallfont};
CP_itemtype SoundSetupSound[] = {{CP_CursorLocation, "\0", 'N', (menuptr)SS_SetupSoundCardMenu},
...
CP_MenuNames SoundSetupMidiPortNames[] = {"220", "230", "240", "250", "300", "320",
...
CP_itemtype SoundSetupMidiPort[] = {
    {CP_Active, "\0", 'a', NULL}, {CP_Active, "\0", 'a', NULL}, {CP_Active, "\0", 'a', NULL},
    {CP_Active, "\0", 'a', NULL}, {CP_Active, "\0", 'a', NULL}, {CP_CursorLocation, "\0", 'a', NULL},
    {CP_Active, "\0", 'a', NULL}, {CP_Active, "\0", 'a', NULL}, {CP_Active, "\0", 'a', NULL},
    {CP_Active, "\0", 'a', NULL}, {CP_Active, "\0", 'a', NULL}, {CP_Active, "\0", 'a', NULL}};

CP_MenuNames SoundSetupVoiceNames[] = {"1 voice",  "2 voices", "3 voices", "4 voices",
                                       "5 voices", "6 voices", "7 voices", "8 voices"};

CP_iteminfo SoundSetupVoiceItems = {MENU_X + 36, 24, 8, STARTITEM, 32, SoundSetupVoiceNames, mn_largefont};
CP_itemtype SoundSetupVoice[] = {{CP_CursorLocation, "\0", 'a', NULL}, {CP_Active, "\0", 'a', NULL},
                                 {CP_Active, "\0", 'a', NULL},         {CP_Active, "\0", 'a', NULL},
                                 {CP_Active, "\0", 'a', NULL},         {CP_Active, "\0", 'a', NULL},
                                 {CP_Active, "\0", 'a', NULL},         {CP_Active, "\0", 'a', NULL}};

CP_MenuNames SoundSetupChannelNames[] = {"  Mono Sound FX", "Stereo Sound FX"};

CP_iteminfo SoundSetupChannelItems = {MENU_X, MP_Y, 2, STARTITEM, 32, SoundSetupChannelNames, mn_largefont};
CP_itemtype SoundSetupChannel[] = {{CP_CursorLocation, "\0", 'M', NULL}, {CP_Active, "\0", 'S', NULL}};

CP_MenuNames SoundSetupResolutionNames[] = {"8 Bit Mixing", "16 Bit Mixing"};

CP_iteminfo SoundSetupResolutionItems = {MENU_X, MP_Y, 2, STARTITEM, 32, SoundSetupResolutionNames, mn_largefont};
CP_itemtype SoundSetupResolution[] = {{CP_CursorLocation, "\0", 'a', NULL}, {CP_Active, "\0", 'b', NULL}};

static int typenums[5] = {fx_SB, fx_SB20, fx_SBPro, fx_SBPro2, fx_SB16};

static char typetostring[6] = {5, 0, 2, 1, 3, 4};

#define UNDEFINED -1

CP_MenuNames TypeNames[] = {"Sound Blaster or compatible", "Sound Blaster 2.0",         "Sound Blaster Pro (old)",
                            "Sound Blaster Pro 2.0 (new)", "Sound Blaster 16 or AWE32", "Undefined"};

CP_iteminfo TypeItems = {MENU_X - 13, MENU_Y + 36, 5, STARTITEM, 10, TypeNames, mn_smallfont};
CP_itemtype TypeMenu[] = {{CP_CursorLocation, "\0", 'S', NULL},
                          {CP_Active, "\0", 'S', NULL},
                          {CP_Active, "\0", 'S', NULL},
                          {CP_Active, "\0", 'S', NULL},
                          {CP_Active, "\0", 'S', NULL}};

static int portnums[7] = {0x210, 0x220, 0x230, 0x240, 0x250, 0x260, 0x280};

CP_MenuNames PortNames[] = {"210", "220", "230", "240", "250", "260", "280"};

CP_iteminfo PortItems = {92, 32, 7, STARTITEM, 32, PortNames, mn_largefont};
CP_itemtype PortMenu[] = {{CP_CursorLocation, "\0", '2', NULL}, {CP_Active, "\0", '2', NULL},
                          {CP_Active, "\0", '2', NULL},         {CP_Active, "\0", '2', NULL},
                          {CP_Active, "\0", '2', NULL},         {CP_Active, "\0", '2', NULL},
                          {CP_Active, "\0", '2', NULL}};

static int _8BitDMAnums[3] = {0, 1, 3};

CP_MenuNames _8BitDMANames[] = {"DMA channel 0", "DMA channel 1", "DMA channel 3"};

CP_iteminfo _8BitDMAItems = {32, 60, 3, STARTITEM, 32, _8BitDMANames, mn_largefont};
CP_itemtype _8BitDMAMenu[] = {{CP_CursorLocation, "\0", '0', NULL},
                              {CP_Active, "\0", '1', NULL},
                              {CP_Active, "\0", '3', NULL}};

static int _16BitDMAnums[3] = {5, 6, 7};

CP_MenuNames _16BitDMANames[] = {"DMA channel 5", "DMA channel 6", "DMA channel 7"};

CP_iteminfo _16BitDMAItems = {32, 60, 3, STARTITEM, 32, _16BitDMANames, mn_largefont};
CP_itemtype _16BitDMAMenu[] = {{CP_CursorLocation, "\0", '5', NULL},
                               {CP_Active, "\0", '6', NULL},
                               {CP_Active, "\0", '7', NULL}};

static int irqnums[8] = {2, 3, 5, 7, 10, 11, 12, 15};

CP_MenuNames IrqNames[] = {"IRQ 2", "IRQ 3", "IRQ 5", "IRQ 7", "IRQ 10", "IRQ 11", "IRQ 12", "IRQ 15"};

CP_iteminfo IrqItems = {82, 24, 8, STARTITEM, 32, IrqNames, mn_largefont};
CP_itemtype IrqMenu[] = {{CP_CursorLocation, "\0", 'a', NULL}, {CP_Active, "\0", 'a', NULL},
                         {CP_Active, "\0", 'a', NULL},         {CP_Active, "\0", 'a', NULL},
                         {CP_Active, "\0", 'a', NULL},         {CP_Active, "\0", 'a', NULL},
                         {CP_Active, "\0", 'a', NULL},         {CP_Active, "\0", 'a', NULL}};

CP_MenuNames SBSetupNames[] = {"Use Current Settings", "Custom Setup"};
...

{
    int status;
    int select;
    if (((musicnums[handlewhich] == SoundBlaster) || (musicnums[handlewhich] == WaveBlaster) ||
         (musicnums[handlewhich] == Awe32)) &&
        (fxnums[FXMode] != SoundBlaster) && (fxnums[FXMode] != Awe32)) {
        CP_ErrorMsg("Music Error",
                    "Please set your Sound FX card to Sound Blaster before "
                    "selecting this card for music.",
                    mn_smallfont);
    ...
    if ((musicnums[MusicMode] == GenMidi) || (musicnums[MusicMode] == SoundCanvas) ||
        (musicnums[MusicMode] == WaveBlaster) || (musicnums[MusicMode] == Awe32)) {
        DrawMusicCardMenu();

        IN_ClearKeysDown();

        select = HandleMenu(&SoundSetupMidiPortItems, &SoundSetupMidiPort[0], NULL);
    ...
    if (MusicMode != 0) {
        if ((musicnums[handlewhich] == WaveBlaster) || (musicnums[handlewhich] == Awe32)) {
            SD_Shutdown();
        }
        ...
        if (status) {
            ...
            CP_ErrorMsg("Music Error", MUSIC_ErrorString(MUSIC_Error), mn_smallfont);
            SS_DrawMusicMenu();
            handlewhich = RETURNVAL;
        } else {
            handlewhich = -1;
        ...
        if ((musicnums[MusicMode] == WaveBlaster) || (musicnums[MusicMode] == Awe32)) {
            status = SD_Startup(false);
            if (status != FX_Ok) {
                CP_ErrorMsg("Sound FX Error", FX_ErrorString(FX_Error), mn_smallfont);
...

{
    ...
    MN_GetActive(&SoundSetupMidiPortItems, &SoundSetupMidiPort[0], MidiAddress, midinums);
...

{
    ...
    status = FX_SetupSoundBlaster(SBSettings, &MaxVoices, &MaxBits, &MaxChannels);
...

{
    ...
    if (FXMode == 0) {
        ...
        if ((fxnums[FXMode] == SoundBlaster) || (fxnums[FXMode] == Awe32)) {
            do {
                SS_DrawSBSetupMenu();
...

{
    ...
    do {
        ...
        which = HandleMenu(&SoundSetupVoiceItems, &SoundSetupVoice[0], NULL);
        if (which >= 0) {
...

{
    ...
    MN_GetActive(&SoundSetupVoiceItems, &SoundSetupVoice[0], NumVoices, voicenums);
...

{
    ...
    do {
        SS_DrawChannelMenu();
        which = HandleMenu(&SoundSetupChannelItems, &SoundSetupChannel[0], NULL);
        if (which >= 0) {
...

{
    ...
    MN_GetActive(&SoundSetupChannelItems, &SoundSetupChannel[0], NumChannels, smnums);
...

{
    ...
    which = HandleMenu(&SoundSetupResolutionItems, &SoundSetupResolution[0], NULL);
...

{
    ...
    MN_GetActive(&SoundSetupResolutionItems, &SoundSetupResolution[0], NumBits, resnums);
