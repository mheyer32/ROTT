...
#ifdef __WATCOMC__
#pragma aux Square = "mov edx,03c4h", "mov eax,0100h", "out dx,ax", "mov eax,0e3h", "mov edx,03c2h", "out dx,ax", \
            "mov eax,0300h", "mov edx,03c4h", "out dx,ax" modify exact[eax edx]
#endif
...
#ifdef __WATCOMC__
#pragma aux my_outp = "out dx,al", parm[edx][eax] modify exact[]
#endif
