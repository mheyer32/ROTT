...
AudioSpec *Mix_LoadVOC_RW(SDL_RWops *src, int freesrc, AudioSpec *spec, unsigned char **audio_buf,
...
Mix_Chunk *Mix_LoadWAV_RW(SDL_RWops *src, int freesrc)
{
    ...
    switch (magic) {
    case CREA:
        loaded = Mix_LoadVOC_RW(src, freesrc, &wavespec, (unsigned char **)&chunk->abuf, &chunk->alen);
        break;
    default:
