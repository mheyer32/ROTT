...
#-Wstrict-prototypes
CFLAGS += -m68030 -msmall-code -mregparm=4 -noixemul
...
CFLAGS += -D__BIG_ENDIAN__ -DPLATFORM_UNIX=1 -Ditoa=ltoa -DAMIGA -D__NO_NET_API -DINDIVISION
